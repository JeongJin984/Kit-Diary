...
const AppLayout = ({ children }) => {
    ...
    return (
        <div>
            <Link href="/">
                <img src="/banner.jpg" width="100%" style={{ cursor: 'pointer' }} />
            </Link>
            <Navbar bg="light" variant="light">
                ...
                {!onLogin && (
                    <Link href="./login">
                        <a>
                            <StyledButton variant="outline-primary">로그인</StyledButton>
                        </a>
                    </Link>
                )}
            </Navbar>
                ...
                <Row>
                    ...
                    <Col xs={3} style={{ padding: '0px' }}>
                        <Row>
                            {onLogin ? (
                                <Card
                                    style={{ width: '18rem', marginTop: '10px', position: 'fixed' }}
                                >
                                    <Card.Img variant="top" src="/cat.png" />
                                    <Card.Body>
                                        <Card.Title>사용자이름</Card.Title>
                                        <Card.Text>자기소개</Card.Text>
                                    </Card.Body>
                                </Card>
                            ) : (
                                <Card
